...
*/
        ...
        var vertexIndex0: VertexIndex { return mesh.vertexIndices[idx + 0] }
        var vertexIndex1: VertexIndex { return mesh.vertexIndices[idx + 1] }
        var vertexIndex2: VertexIndex { return mesh.vertexIndices[idx + 2] }
